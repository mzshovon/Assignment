        ...
        <div class="register-content">
            <form action="<?php echo URLROOT.'/'.$_SESSION["lang"].'/auth/register';?>" method="POST" name="register_form">
                ...
                <div class="form-group">
                    ...
                    <input name="email" type="text" class="form-control form-control-lg fs-15px" placeholder="username@address.com" value="" />
                </div>
                <div class="form-group">
                    <label>Password <span class="text-danger">*</span></label>
                    <input name="pass" type="password" class="form-control form-control-lg fs-15px" value="" />
                </div>
                <div class="form-group">
