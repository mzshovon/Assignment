<?php
require_once APPROOT . '/views/inc/backend/header.php';
require_once APPROOT . '/views/inc/backend/sidebar.php';
?>
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                ...
                <div class="card text-white-transparent-7 mb-3 overflow-hidden">
                    ...
                    <div class="card-img-overlay d-none d-md-block bg-blue rounded" style="background-image: url(<?php echo URLROOT.'/backend/';?>assets/img/bg/wave-bg.png); background-position: right bottom; background-repeat: no-repeat; background-size: 100%;"></div>
                    ...
                    <div class="card-img-overlay d-none d-md-block bottom-0 top-auto">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xl-6 mb-n2">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/page/dashboard.svg" class="d-block ml-n3 mb-5" style="max-height: 310px" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange" style="min-height: 202px;">
                            ...
                            <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/icon/order.svg" class="ml-auto d-block mb-n3" style="max-height: 105px" />
                            </div>
                        ...
                        <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal" style="min-height: 202px;">
                            ...
                            <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/icon/visitor.svg" class="ml-auto d-block mb-n3" style="max-height: 105px" />
                            </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-pink" style="min-height: 202px;">
                            ...
                            <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/icon/email.svg" class="ml-auto d-block mb-n3" style="max-height: 105px" />
                            </div>
                        ...
                        <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo" style="min-height: 202px;">
                            ...
                            <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/icon/browser.svg" class="ml-auto d-block mb-n3" style="max-height: 105px" />
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/product/product-1.jpg" alt="" class="mw-100 mh-100" />
                            </div>
                            <div class="flex-grow-1">
                                <div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/product/product-2.jpg" alt="" class="mw-100 mh-100" />
                            </div>
                            <div class="flex-grow-1">
                                <div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/product/product-3.jpg" alt="" class="mw-100 mh-100" />
                            </div>
                            <div class="flex-grow-1">
                                <div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/product/product-4.jpg" alt="" class="mw-100 mh-100" />
                            </div>
                            <div class="flex-grow-1">
                                <div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center justify-content-center mr-3 width-50 height-50">
                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/product/product-5.jpg" alt="" class="mw-100 mh-100" />
                            </div>
                            <div class="flex-grow-1">
                                <div>
                            ...
                            <table class="table table-borderless mb-0">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="width-40 height-40">
                                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/icon/paypal2.svg" class="mw-100 mh-100" />
                                            </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="width-40 height-40 rounded">
                                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/icon/mastercard.svg" class="mw-100 mh-100" />
                                            </div>
                                            <div class="ml-3 flex-grow-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="width-40 height-40 rounded">
                                                <img src="<?php echo URLROOT.'/backend/';?>assets/img/icon/visa.svg" class="mw-100 mh-100" />
                                            </div>
                                            <div class="ml-3 flex-grow-1">
...
<?php
require_once APPROOT . '/views/inc/backend/footer.php';
?>
